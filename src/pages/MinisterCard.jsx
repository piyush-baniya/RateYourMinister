...
const MinisterCard = ({ minister, session, onRatingSuccess, userRating }) => {
  ...
  return (
    <>
      <Link to={`/minister/${minister.id}`} className="block">
        <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition-all duration-300 flex flex-col border border-transparent hover:border-indigo-500 group h-full">
